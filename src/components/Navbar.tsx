...
export function Navbar() {
  ...
  return (
    <nav className="bg-brand px-4 sm:px-6 py-3 sm:py-4">
      <div className="flex items-center justify-between">
        <Link href="/" className="font-damion text-xl sm:text-2xl text-white">
          Rom Com Sundays
        </Link>
      ...
      {menuOpen && (
        <div className="md:hidden mt-4 flex flex-col gap-4 pb-2">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 bg-white text-brand font-bold text-sm px-4 py-2 rounded-lg w-fit"
            onClick={() => setMenuOpen(false)}
          >
